...
void test_set_create_from_sorted_values(void) {
	...
	set = set_create_from_sorted_values(compare_ints,NULL,vec);

	TEST_ASSERT(*(int*)set_first(set)==4);
}
...
TEST_LIST = {
	...
	{ "set_create_from_sorted_values", test_set_create_from_sorted_values},
